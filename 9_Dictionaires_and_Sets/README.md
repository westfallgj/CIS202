Write a program that opens a specified text file then displays a list of all the unique words found in the file. Use a set. The text file to test against is attached.
